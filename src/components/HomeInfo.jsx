...
const renderContent = {
    1: (
        ...
        Hi, I am <span className="font-semibold">Hanna</span>
        <br/>
    ...
    2: (
        <InfoBox 
            text="Proficient in JavaScript, React.js, and Node.js, with a strong background 
            in designing scalable web applications."
            link="/about"
            btnText="Learn more"
        />
    ),
